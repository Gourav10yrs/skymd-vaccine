<template>
  <div class="container">
    <div class="container__width">
      ...
      <h3 class="intropage__title">Please answer the health questions below Information</h3>
      ...
      <a class="intropage__button" type="button" href="/form3">CONTINUE</a>
    </div>
  </div>
</template>
